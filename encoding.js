...
else{ g=this } g.Encoding=f() } })(function (){
    ...
    1: [function (require, module, exports){
      ...
      function isJIS(data){
        ...
        for (;i<len;i++){
          ...
          if (b===0x1B){
            ...
            else if (esc===0x26&&// JIS X 0208-1990
              esc2===0x40){
              return true;
            }
            else if (esc===0x28){
      ...
      function isUTF16(data){
        ...
        if (len<2){
          ...
          b1=data[0];
          b2=data[1];
          if (b===0xFF&&// BOM (little-endian)
            b2===0xFE){
            return true;
          }
          if (b===0xFE&&// BOM (big-endian)
            b2===0xFF){
            return true;
          }
      ...
      function isUTF32(data){
        ...
        if (len<4){
          ...
          b3=data[2];
          b4=data[3];
          if (b===0x00&&b2===0x00&&// BOM (big-endian)
            b3===0xFE&&b4===0xFF){
            return true;
          }

          if (b===0xFF&&b2===0xFE&&// BOM (little-endian)
            b3===0x00&&b4===0x00){
            return true;
          }
